...
import nl.fontys.s3.backend.mapper.ListingMapper;
import nl.fontys.s3.backend.entity.Listing;
import nl.fontys.s3.backend.repository.interfaces.ListingRepository;
import nl.fontys.s3.backend.service.interfaces.ListingService;
import nl.fontys.s3.backend.spec.ListingsSpec;
